...
CREATE TABLE IF NOT EXISTS `test2`.`chat_messages` (
  ...
  CONSTRAINT `FK_chatRoom_TO_chat_messages_1`
    FOREIGN KEY (`room_id`)
    REFERENCES `test2`.`chat_room` (`room_id`),
